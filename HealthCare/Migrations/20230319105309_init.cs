    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AthleteInformationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteInformation", x => x.AthleteInformationId);
                    table.ForeignKey(
                        name: "FK_AthleteInformation_AspNetUsers_AthleteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Meal_AspNetUsers_AthleteId",
                        column: x => x.AthleteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Meal_AthleteInformation_AthleteInformationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BurnedCalories = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PhysicalActivity_AspNetUsers_AthleteId",
                        column: x => x.AthleteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteInformation_AthleteId",
                table: "AthleteInformation",
                column: "AthleteId");

            migrationBuilder.CreateIndex(
                name: "IX_Meal_AthleteId",
                table: "Meal",
                column: "AthleteId");

            migrationBuilder.CreateIndex(
                name: "IX_Meal_AthleteInformationId",
                table: "Meal",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhysicalActivity_AthleteId",
